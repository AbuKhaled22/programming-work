/*
Created by <FADHEL ABDULLAH KHALED MOHAMMED THABIT > on <28/10/2022>
Copyright © 2019 Dr Badariah. All rights reserved. (sample)
Date Created: 28/10/2022 4:00PM
...
int main(){
    ...
    //OUTPUT message 2
        <<setw(10)<<left<<"  Degree Celcius  "<<setw(20)<<right<<"  Degree Fahrenheit\n";
    //while(Celcius<=100 && Fahrenheit<=212)
